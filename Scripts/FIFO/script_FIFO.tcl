...
set_attr script_search_path ./Scripts/FIFO/
set_attr init_hdl_search_path ./Design/FIFO/
...
#report_gates 
#report_power > ./Synthesis/FIFO/power.txt

#Step 8 Check design for timing errors
check_design > ./Synthesis/FIFO/design_check.txt
#suspend

#Step 9: Write out synthesised netlist and constraints- important output
write_hdl > ./Synthesis/FIFO/hdl_synthesis.v
write_sdc > ./Synthesis/FIFO/FIFO_genus.sdc  

#Step 10: Report final results
report_gates 
report_area > ./Synthesis/FIFO/area.txt
report_power > ./Synthesis/FIFO/power.txt
report_timing > ./Synthesis/FIFO/timing.txt
#suspend  --> Change constraints --clock, redo read_hdc, syn_generic, syn_map, syn_opt and report_timing --> to check slack.


write_hdl > ./Design/FIFO/PostSynth_Sim/FIFO_syn.sv 
write_sdf > ./Design/FIFO/PostSynth_Sim/FIFO.sdf
write_sdc > ./Synthesis/FIFO/FIFO_genus.sdc 
