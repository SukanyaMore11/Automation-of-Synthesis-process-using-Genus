...
set_attr script_search_path ./Scripts/Counter/
set_attr init_hdl_search_path ./Design/Counter/
...
read_sdc ./SDC/Counter/Counter.sdc
#This is part of sdc: create_clock -name clk -period 2 -waveform {0 1} [get_ports "clk"] --> 2--> ns
#Slack is in ps

#read_vcd ./Design/Counter/PostSynth_Sim/simvision.vcd
...
#report_gates 
#report_power > ./Synthesis/Counter/power.txt

#Step 8 Check design for timing errors
check_design > ./Synthesis/Counter/design_check.txt
#suspend

#Step 9: Write out synthesised netlist and constraints- important output
write_hdl > ./Synthesis/Counter/hdl_synthesis.v
write_sdc > ./Synthesis/Counter/Counter_genus.sdc  

#Step 10: Report final results
report_gates 
report_area > ./Synthesis/Counter/area.txt
report_power > ./Synthesis/Counter/power.txt
report_timing > ./Synthesis/Counter/timing.txt
#suspend  --> Change constraints --clock, redo read_hdc, syn_generic, syn_map, syn_opt and report_timing --> to check slack.


write_hdl > ./Design/Counter/PostSynth_Sim/Counter_syn.sv 
write_sdf > ./Design/Counter/PostSynth_Sim/Counter.sdf
write_sdc > ./Synthesis/Counter/Counter_genus.sdc  
