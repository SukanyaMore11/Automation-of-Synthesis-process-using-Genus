...
set_attr script_search_path ./Scripts/Processor/
set_attr init_hdl_search_path ./Design/Processor/
...
#Step 2: Read netlist
read_hdl -sv {top_processor.sv Stage1_Execute.sv Stage2_ALU.sv SHIFT_ALU.sv ARITH_ALU.sv}
...
read_sdc ./SDC/Processor/Processor.sdc
#This is part of sdc: create_clock -name clk -period 2 -waveform {0 1} [get_ports "clk"] --> 2--> ns
#Slack is in ps

read_vcd ./Design/Processor/PostSynth_Sim/simvision.vcd
...
check_design > ./Synthesis/Processor/design_check.txt
#suspend

#Step 9: Write out synthesised netlist and constraints- important output
write_hdl > ./Synthesis/Processor/hdl_synthesis.v
write_sdc > ./Synthesis/Processor/Processor_genus.sdc  

#Step 10: Report final results
report_gates 
report_area > ./Synthesis/Processor/area.txt
report_power > ./Synthesis/Processor/power.txt
report_timing > ./Synthesis/Processor/timing.txt
#suspend  --> Change constraints --clock, redo read_hdc, syn_generic, syn_map, syn_opt and report_timing --> to check slack.


write_hdl > ./Design/Processor/PostSynth_Sim/Processor_syn.sv 
write_sdf > ./Design/Processor/PostSynth_Sim/Processor.sdf
write_sdc > ./Synthesis/Processor/Processor_genus.sdc  
