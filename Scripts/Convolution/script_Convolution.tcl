#Cd to ....../2_stage_processor/synthesis
...
set_attr script_search_path ./Scripts/Convolution/
set_attr init_hdl_search_path ./Design/Convolution/
...
#Step 2: Read netlist
read_hdl -sv {top_module.sv Stage_1_to_4.sv}
...
read_sdc ./SDC/Convolution/Convolution.sdc
#This is part of sdc: create_clock -name clk -period 2 -waveform {0 1} [get_ports "clk"] --> 2--> ns
#Slack is in ps

read_vcd ./Design/Convolution/PostSynth_Sim/simvision.vcd
...
#report_gates 
#report_power > ./Synthesis/Processor/power.txt

#Step 8 Check design for timing errors
check_design > ./Synthesis/Convolution/design_check.txt
#suspend

#Step 9: Write out synthesised netlist and constraints- important output
write_hdl > ./Synthesis/Convolution/hdl_synthesis.v
write_sdc > ./Synthesis/Convolution/Convolution.sdc  

#Step 10: Report final results
report_gates 
report_area > ./Synthesis/Convolution/area.txt
report_power > ./Synthesis/Convolution/power.txt
report_timing > ./Synthesis/Convolution/timing.txt
#suspend  --> Change constraints --clock, redo read_hdc, syn_generic, syn_map, syn_opt and report_timing --> to check slack.


write_hdl > ./Design/Convolution/PostSynth_Sim/Convolution_syn.sv 
write_sdf > ./Design/Convolution/PostSynth_Sim/Convolution.sdf
write_sdc > ./Synthesis/Convolution/Convolution_genus.sdc  
